...
Much of this process was incredibly new to me but since it was based in ggplot and data visualization, I had a good foundation to work off of. This assignment was definitely a lot harder than I expected. I found the exercises and tutorials pretty tricky to follow, I could've used more explanation and I think it was aimed at someone with a higher skill level. All in all this assignment was very fun and I enjoyed challenging myself. I learned a lot more about the customization of ggplot, making polygons, and a ton of cool filters and distortions. One thing that was challenging for me was understanding the data mapping and aesthetics, that code would vary between pieces without explanation, so I spent a decent amount of time playing around with those and figuring out what they control. I probably spent the most time on the getting started section, definitely more than I needed to, however the hardest section for me was polygon tricks. I was very unsure as to how much I was supposed to change in the tutorials and I definitely was repetitive in what I included in the code, particularly for the polygons and associated functions, but I had encountered some errors not finding functions so I started copying and pasting all the code from the Rscripts provided so they would run. I definitely learned the most new material from this assignment and I really enjoyed the creativity in addition to the problem solving. Making my pieces was the most fun aspect of the project and in the future I will definitely be playing around with more generative art, notably multicolored backgrounds as I was unable to do so while working on this. 
